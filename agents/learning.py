"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for crispr-offtarget-scanner.
"""
import math
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Crispr Offtarget Scanner"):
